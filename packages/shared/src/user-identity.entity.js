...
__decorate([
    ...
    __metadata("design:type", String)
], UserIdentity.prototype, "providerId", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'uuid' }),
    __metadata("design:type", String)
], UserIdentity.prototype, "userId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.identities, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'user_id' }),
    __metadata("design:type", user_entity_1.User)
], UserIdentity.prototype, "user", void 0);
exports.UserIdentity = UserIdentity = __decorate([
    (0, typeorm_1.Entity)('user_identities'),
