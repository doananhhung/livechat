...
import { InvitationStatus, Role, ProjectRole } from "@live-chat/shared-types";
...
export class CreateInvitationDto {
  ...
  @ApiProperty({
    ...
    enum: ProjectRole,
    description: "Role to assign to the invited user (defaults to AGENT)",
    required: false,
  })
  @IsEnum(ProjectRole)
  @IsOptional()
...
export class AcceptInvitationDto {
  @ApiProperty({
    ...
    description: "Token received in the invitation link",
  })
  @IsString()
  token: string;
}
