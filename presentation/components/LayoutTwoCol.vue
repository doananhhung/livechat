<template>
  ...
  >
    ...
    >
      ...
      <div class="grid grid-cols-2 gap-10 h-full overflow-hidden">
        <div
          class="bg-white/80 backdrop-blur-sm p-6 shadow-lg border-t-4 border-indigo-500 rounded-lg h-full overflow-y-auto"
        >
          <slot name="left" />
        </div>
        <div
          class="bg-white/80 backdrop-blur-sm p-6 shadow-lg border-t-4 border-purple-500 rounded-lg h-full overflow-y-auto"
        >
          <slot name="right" />
        </div>
      </div>
